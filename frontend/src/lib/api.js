...
export async function createMessageNotification(notificationData) {
  const response = await axiosInstance.post(
    "/users/message-notification",
    notificationData
  );
  return response.data;
}
...
export async function getMessageNotifications() {
  const response = await axiosInstance.get("/users/message-notifications");
  return response.data;
}
