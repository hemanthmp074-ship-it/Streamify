...
import { acceptFriendRequest, getFriendRequests, getMessageNotifications, markNotificationsAsRead } from "../lib/api";
...
const NotificationsPage = () => {
  ...
  // Mark notifications as read after a delay when page is viewed
  useEffect(() => {
  ...
  }, [messageNotifications.length, markAsReadMutation]);
            ...
            {messageNotifications.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                  ...
                  New Messages
                  <span className="badge badge-info ml-2">{messageNotifications.length}</span>
                </h2>
                      ...
                      <div className="card-body p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm my-1">{notification.messageText}</p>
                            <p className="text-xs flex items-center opacity-70">
                              <ClockIcon className="h-3 w-3 mr-1" />
                              Recently
                            </p>
